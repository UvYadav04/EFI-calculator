...
form1.addEventListener('submit', function (e) {
    ...
    if (point_input.checked == 1) {
        ...
        form2.addEventListener('submit', (e) => {
            ...
            for (let i = charge_no.value; i > 0; i--) {
                ...
                label2.innerText = `ax${i}:`
                label3.innerText = `ay${i}:`
                label4.innerText = `az${i}:`
    ...
    label_refx.innerText = "ax:"
    label_refy.innerText = "ay:"
    label_refz.innerText = "az:"

    input_refx.style.width = '30px'
    input_refy.style.width = '30px'
    input_refz.style.width = '30px'
...
form3.addEventListener('submit', function (e) {
    ...
    let xr = xref.valueAsNumber
    let yr = yref.valueAsNumber
    let zr = zref.valueAsNumber
    ...
    if (point_input.checked == 1) {
        ...
        const rx = document.querySelectorAll('#rx')
        const ry = document.querySelectorAll('#ry')
        const rz = document.querySelectorAll('#rz')
        ...
        for (let j = 0; j < size.value; j++)
            x.push(rx[j].valueAsNumber)

        // console.log(x)

        let y = []
        for (let k = 0; k < size.value; k++)
            y.push(ry[k].valueAsNumber)

        // console.log(y)

        let z = []
        for (let l = 0; l < size.value; l++)
            z.push(rz[l].valueAsNumber)
    ...
    calculation.innerText = `(${Ex.toPrecision(3)}ax + ${Ey.toPrecision(3)}ay + ${Ez.toPrecision(3)}az)e+12`
